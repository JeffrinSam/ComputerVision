...
def facialpoints():
    PREDICTOR_PATH = "E:\Computer Vision stuff\OpenCV\FACEMODEL\shape_predictor_68_face_landmarks.dat"
    ...
    def annotate_landmarks(im, landmarks):
        ...
        for idx, point in enumerate(landmarks):
            ...
            cv2.putText(im, str(idx), pos, fontFace=cv2.FONT_HERSHEY_SCRIPT_SIMPLEX,fontScale=0.1, color=(0, 0, 255))
...
image1 = cv2.imread('E:\Computer Vision stuff\OpenCV\images\images\Trump.jpg')
image2 = cv2.imread('E:\Computer Vision stuff\OpenCV\images\images\kim.jpg')
